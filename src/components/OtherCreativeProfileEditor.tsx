...
interface OtherCreativeProfile {
  id: string
  displayName: string
  bio: string | null
...
interface Props {
  profile: OtherCreativeProfile
}

export default function OtherCreativeProfileEditor({ profile }: Props) {
  ...
  const handleSubmit = async (e?: React.FormEvent) => {
    ...
    try {
      ...
      const updateData = {
        ...
        slug: formData.displayName ? slugify(formData.displayName) : null,
  ...
  return (
    <form onSubmit={handleSubmit} className="max-w-4xl mx-auto space-y-8">
      <div className="bg-white rounded-lg shadow-sm border p-6">
        <h3 className="text-lg font-semibold text-austin-charcoal mb-4">Profile</h3>
